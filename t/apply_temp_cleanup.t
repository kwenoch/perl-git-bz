        ...
        my @attachments = (
            {
                ...
                data    =>
                    ''
            },
            {
                id      => 456,
                summary => 'Test patch 2',
                data    =>
                    'RnJvbSBhYmNkZWYgTW9uIFNlcCAxNyAwMDowMDowMCAyMDAxCkZyb206IFRlc3QgVXNlciA8dGVzdEB0ZXN0LmNvbT4KRGlzdDogdGVzdCBwYXRjaAo='
            }
        );
...
subtest 'apply_patches sequential application' => sub {
    ...
    subtest 'saves remaining patches on partial failure' => sub {
        ...
        stderr_like(
            ...
            qr/Patch application failed for attachment 222 - Patch 2/,
            'Shows error message for failed patch'
        );
