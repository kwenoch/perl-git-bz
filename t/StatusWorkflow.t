...
t/StatusWorkflow.t - Test status workflow transitions

=cut

subtest 'patch doesnt apply workflow transitions' => sub {
    plan tests => 9;
    ...
    my @expected =
        ( 'ASSIGNED', 'RESOLVED', 'BLOCKED', 'In Discussion', 'Needs Signoff', 'Signed Off', 'Passed QA', 'Failed QA' );
